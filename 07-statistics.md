...
>> A twin can be identical or fraternal only, and not both. So the probability of a twin in the population is the sum of the probabilities of identical and fraternal twins.  
>> So we have:  
>> P(Fraternal twin) = 1/125  
>> P(Identical twin) = 1/300  
>> P(Twin) = 1/125 + 1/300  
>> 
>> Using Beyes' Theorem, we can calculate the probability that Elvis was an identical twin, given that we know that he was a twin:  
>> P(Identical twin | Twin) = (1 * 1/300)/(1/125 + 1/300) = 0.29411764705  
>>
>> The probability that Elvis was an identical twin is 29.41%, given that he was a twin.
